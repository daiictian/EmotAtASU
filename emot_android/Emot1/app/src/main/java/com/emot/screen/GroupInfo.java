...
public class GroupInfo extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.emot.screen.R.layout.group_info);
		changeGroup = (ImageView)findViewById(com.emot.screen.R.id.changeSubject);
		enterNewGroupSubject = (EditText)findViewById(com.emot.screen.R.id.EnterSubject);
		currentSubject = (TextView)findViewById(com.emot.screen.R.id.currentGrpSubject);
		currentList = (ListView)findViewById(com.emot.screen.R.id.listviewMembers);
		subject = getIntent().getStringExtra("currentSubject");
		mChangeSubject = (Button)findViewById(com.emot.screen.R.id.changeSubjectButton);
