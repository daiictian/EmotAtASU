...
public class Emots extends Activity {
	...
	private void setOnClickListeners(){
		...
		emotsList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				TextView user = (TextView)view.findViewById(com.emot.screen.R.id.username);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.emot.screen.R.layout.layout_emots);
		initUI();
		setOnClickListeners();
	...
	private void initUI() {
		emotsList = (ListView)findViewById(com.emot.screen.R.id.emotListView);
